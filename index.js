...
'<p style="color: ' +
      color +
"\">Command list:<br>help: shows this help panel.<br>info: shows information about this pen.<br>clear: clears the console<br>codepen [pen id] [view]: browses to codepen, at the specified pen id, with the specified view (pen, details, full, debug).<br>codepenuser [user]: browses to the specified user's codepen profile.<br>codepensearch [query]: searches Codepen for your query.<br>url [url]: browses to the specified url.<br>google [query]: searches Google for your query.<br>youtube [query]: searches YouTube for your query.<br>print [text]: prints text to the console.<br>color [value]: sets the color of the console's text, or resets it if no color is specified.<br>js [code]: executes some JavaScript code.<br></p>";
  } else if (commands[0] == "info") {
log.innerHTML += "<p style='color: " + color + "'>This pen was made by ZOSK, a young amateur web and game developer. Check out my Twitter account <a style='color: "+ color +";' href='https://twitter.com/ZOSK17'>here</a>.</p><br>";
  } else if (commands[0] == "codepen") {
if (commands[2]) {
window.open("https://codepen.io/ZOSK/" + commands[2] + "/" + commands[1]);
    } else {
window.open("https://codepen.io/ZOSK/pen/" + commands[1]);
    }
...
if (commands[1]) {
window.open("https://google.com/search?q=" + parameters);
    } else {
log.innerHTML +=
"<p style='color: red'>Error: No query specified.</p><br>";
    }
...
if (commands[1]) {
window.open("https://youtube.com/search?q=" + parameters);
    } else {
log.innerHTML +=
"<p style='color: red'>Error: No query specified.</p><br>";
    }
