...
'<p style="color: ' +
      color +
"\">Command list:<br>help: shows this help panel.<br>info: shows information about this console.<br>clear: clears the console<br>codepen [pen id] [view]: browses to codepen, at the specified pen id, with the specified view (pen, details, full, debug).<br>codepenuser [user]: browses to the specified user's codepen profile.<br>codepensearch [query]: searches Codepen for your query.<br>url [url]: browses to the specified url.<br>cache [url] [view]: browses to the cache of the specified url, and on the specified view.(full,text,source)<br>google [query]: searches Google for your query.<br>youtube [query]: searches YouTube for your query.<br>print [text]: prints text to the console.<br>color [value]: sets the color of the console's text, or resets it if no color is specified.<br>js [code]: executes some JavaScript code.<br></p>";
